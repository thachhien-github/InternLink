...
export const NotificationsView = () => {
  const [notifications, setNotifications] = useState(USE_MOCK ? [
    {
      id: "1",
      title:
        "Nguy\u1EC5n V\u0103n A ch\u01B0a n\u1ED9p b\xE1o c\xE1o tu\u1EA7n 5",
      ...
      content:
        "Th\u01B0a Th\u1EA7y, h\u1EC7 th\u1ED1ng t\u1EF1 \u0111\u1ED9ng ghi nh\u1EADn sinh vi\xEAn Nguy\u1EC5n V\u0103n A thu\u1ED9c L\u1EDBp C24A.TH1 ch\u01B0a n\u1ED9p B\xE1o c\xE1o tu\u1EA7n 5 (H\u1EA1n ch\xF3t: 23:59 ng\xE0y 28/10). Vui l\xF2ng g\u1EEDi th\xF4ng b\xE1o nh\u1EAFc nh\u1EDF ho\u1EB7c li\xEAn h\u1EC7 tr\u1EF1c ti\u1EBFp sinh vi\xEAn qua email / \u0111i\u1EC7n tho\u1EA1i.",
      attachments: ["BaoCao_Tuan4_NguyenVanA.pdf"],
    },
    {
      id: "2",
      title:
        "Doanh nghi\u1EC7p FPT x\xE1c nh\u1EADn ti\u1EBFp nh\u1EADn sinh vi\xEAn",
      ...
      content:
        "K\xEDnh g\u1EEDi Th\u1EA7y Tr\u1EA7n Minh Huy, C\xF4ng ty FPT Software xin th\xF4ng b\xE1o \u0111\xE3 ti\u1EBFp nh\u1EADn th\xE0nh c\xF4ng 6 sinh vi\xEAn do Th\u1EA7y h\u01B0\u1EDBng d\u1EABn v\xE0o c\xE1c v\u1ECB tr\xED Th\u1EF1c t\u1EADp sinh Fullstack v\xE0 React Frontend. H\u1EE3p \u0111\u1ED3ng \u0111\xE0o t\u1EA1o v\xE0 k\u1EBF ho\u1EA1ch c\xF4ng vi\u1EC7c chi ti\u1EBFt \u0111\xEDnh k\xE8m b\xEAn d\u01B0\u1EDBi.",
      attachments: [
        "HopDong_TiepNhan_FPT_2026.pdf",
        "DanhSach_SinhVien_FPT.xlsx",
      ],
    },
    {
      id: "3",
      title:
        "B\xE1o c\xE1o gi\u1EEFa k\u1EF3 c\u1EE7a Tr\u1EA7n V\u0103n B \u0111\xE3 \u0111\u01B0\u1EE3c ph\xEA duy\u1EC7t",
      ...
      content:
        "B\xE0i n\u1ED9p B\xE1o c\xE1o Gi\u1EEFa k\u1EF3 c\u1EE7a sinh vi\xEAn Tr\u1EA7n V\u0103n B \u0111\u1EA1t ch\u1EA5t l\u01B0\u1EE3ng r\u1EA5t t\u1ED1t. \u0110\u1EC1 t\xE0i ph\xE1t tri\u1EC3n h\u1EC7 th\u1ED1ng microservices \u0111\u01B0\u1EE3c gi\u1EA3ng vi\xEAn v\xE0 c\xE1n b\u1ED9 k\u1EF9 thu\u1EADt Viettel \u0111\xE1nh gi\xE1 cao. \u0110\xE3 duy\u1EC7t b\xE1o c\xE1o chuy\u1EC3n sang giai \u0111o\u1EA1n 2.",
      attachments: ["PhieuDanhGia_GiuaKy_TranVanB.pdf"],
    },
    {
      id: "4",
      title:
        "C\xF3 bi\u1EC3u m\u1EABu \u0111\xE1nh gi\xE1 doanh nghi\u1EC7p m\u1EDBi \u0111\u01B0\u1EE3c t\u1EA3i l\xEAn",
      ...
      content:
        "Khoa C\xF4ng ngh\u1EC7 Th\xF4ng tin v\u1EEBa c\u1EADp nh\u1EADt bi\u1EC3u m\u1EABu BM-04 (Phi\u1EBFu \u0111\xE1nh gi\xE1 d\xE0nh cho C\xE1n b\u1ED9 h\u01B0\u1EDBng d\u1EABn Doanh nghi\u1EC7p \u0111\u1EE3t H\u1ECDc k\u1EF3 I - 2026). \u0110\u1EC1 ngh\u1ECB c\xE1c Th\u1EA7y/C\xF4 g\u1EEDi bi\u1EC3u m\u1EABu n\xE0y cho \u0111\u1EA1i di\u1EC7n doanh nghi\u1EC7p \u0111\u1EC3 l\u1EA5y ph\u1EA3n h\u1ED3i ch\xEDnh th\u1EE9c tr\u01B0\u1EDBc tu\u1EA7n 12.",
      attachments: ["BM04_DanhGia_DoanhNghiep_2026.docx"],
    },
    {
      id: "5",
      title:
        "H\u1EC7 th\u1ED1ng s\u1EBD \u0111\xF3ng \u0111\u1EE3t th\u1EF1c t\u1EADp H\u1ECDc k\u1EF3 I sau 3 ng\xE0y",
      ...
      receiver: "Gi\u1EA3ng vi\xEAn Tr\u1EA7n Minh Huy",
      content:
        "Nh\u1EAFc nh\u1EDF t\u1EF1 \u0111\u1ED9ng t\u1EEB C\u1ED5ng \u0110\xE0o t\u1EA1o: \u0110\u1EE3t th\u1EF1c t\u1EADp H\u1ECDc k\u1EF3 I - 2026 s\u1EBD ch\xEDnh th\u1EE9c kh\xF3a s\u1ED5 nh\u1EADp \u0111i\u1EC3m v\xE0o 23:59 ng\xE0y 30/10/2026. \u0110\u1EC1 ngh\u1ECB Gi\u1EA3ng vi\xEAn ho\xE0n t\u1EA5t ch\u1EA5m \u0111i\u1EC3m ti\xEAu chu\u1EA9n v\xE0 ph\xEA duy\u1EC7t b\xE1o c\xE1o tr\u01B0\u1EDBc th\u1EDDi h\u1EA1n.",
      attachments: [],
    },
  ] : []);
  const [selectedNotif, setSelectedNotif] = useState(
    USE_MOCK ? notifications[0] : null,
  );
  ...
  const [scheduledList, setScheduledList] = useState([
    {
      id: "s1",
      title:
        "Nh\u1EAFc nh\u1EDF n\u1ED9p B\xE1o c\xE1o Tu\u1EA7n 6 \u0111\u1EE3t HK I - 2026",
    ...
    },
    {
      id: "s2",
      title:
        "Y\xEAu c\u1EA7u doanh nghi\u1EC7p x\xE1c nh\u1EADn phi\u1EBFu \u0111\xE1nh gi\xE1 cu\u1ED1i \u0111\u1EE3t",
  ...
  const handleToggleRead = async (id: string, e?: React.MouseEvent) => {
    ...
    if (selectedNotif?.id === id) {
      setSelectedNotif((prev) => (prev ? { ...prev, isUnread: false } : prev));
    }
  };
  ...
  const handleSendCompose = (e) => {
    ...
    if (isScheduledOption) {
      ...
      showToast(
        `\u0110\xE3 l\xEAn l\u1ECBch g\u1EEDi th\xF4ng b\xE1o cho ${composeAudience} th\xE0nh c\xF4ng!`,
      );
    } else {
      const newNotif = {
        id: `n_${Date.now()}`,
      ...
      showToast(
        `\u0110\xE3 g\u1EEDi th\xF4ng b\xE1o cho ${composeAudience} th\xE0nh c\xF4ng!`,
      );
    }
  ...
  const filteredNotifications = notifications
    .filter((n) => {
      ...
      if (filterType === "Kh\u1EA9n c\u1EA5p")
        return n.priority === "Kh\u1EA9n c\u1EA5p";
      if (filterType === "H\u1EC7 th\u1ED1ng") return n.type === "system";
      if (filterType === "Sinh vi\xEAn")
        return n.type === "student" || n.student;
      if (filterType === "Doanh nghi\u1EC7p")
        return n.type === "enterprise" || n.company;
      return true;
    })
    .sort((a, b) => {
  ...
  return (
    <div className="space-y-5 max-w-[1500px] mx-auto animate-in fade-in duration-200 pb-12 font-sans min-w-0 overflow-hidden">
      ...
      <PageHeader
        icon={Bell}
        title="Trung tâm Thông báo & Trao đổi"
        subtitle="Quản lý thông báo, nhắc nhở và trao đổi với sinh viên và doanh nghiệp trong quá trình thực tập."
        actions={[
          {
          ...
          },
          {
            ...
            icon: User,
            onClick: () =>
              openComposeWithAudience(
                "Theo sinh vi\xEAn",
                "Nh\u1EAFc nh\u1EDF c\xE1 nh\xE2n: ",
              ),
            variant: "secondary",
          },
          {
            label: "Thông báo toàn lớp HD",
            icon: Mail,
            onClick: () =>
              openComposeWithAudience(
                "To\xE0n b\u1ED9 sinh vi\xEAn",
                "Th\xF4ng b\xE1o L\u1EDBp h\u01B0\u1EDBng d\u1EABn: ",
              ),
            variant: "secondary",
          },
        ]}
      ...
      <KpiGrid>
        <KpiCard
          ...
          unit="tin mới"
          icon={Bell}
          footer="Cập nhật liên tục trong ngày"
          onClick={() => {
            setSearchQuery("");
        ...
        <KpiCard
          tone="amber"
          title="Chưa đọc / Cần xem"
          value={`0${unreadCount}`}
          unit="thông báo"
          icon={AlertCircle}
          footer="Cần sinh viên phản hồi"
          onClick={() => setFilterType("Ch\u01B0a \u0111\u1ECDc")}
        />
        <KpiCard
          tone="emerald"
          title="Sinh viên HD tiếp nhận"
          value={28}
          unit="sinh viên"
          icon={UserCheck}
          footer="Thuộc phân bổ giảng viên"
          onClick={() => setFilterType("Sinh vi\xEAn")}
        />
        <KpiCard
          tone="rose"
          title="Khẩn cấp / Nhắc nhở"
          value={
            notifications.filter((n) => n.priority === "Kh\u1EA9n c\u1EA5p")
              .length
          }
          unit="nhắc nhở"
          icon={AlertTriangle}
          footer="Cần xử lý trễ hạn & Nộp bài"
                  ...
                  if (!USE_MOCK) {
                    try {
                      ...
                      setSelectedNotif((prev) =>
                        prev
                          ? mapped.find((n) => n.id === prev.id) ?? mapped[0] ?? null
                          : mapped[0] ?? null,
                      );
                      showToast(
          ...
          {filteredNotifications.length === 0 ? (
            ...
            <div className="bg-white p-8 rounded-lg border border-slate-200 text-center space-y-3">
              ...
              <p className="text-xs text-slate-500 max-w-xs mx-auto">
                Không tìm thấy thông báo phù hợp với bộ lọc hoặc từ khóa tìm
                kiếm của bạn.
              </p>
              <button
                onClick={() => {
              ...
              {filteredNotifications.map((notif) => {
                ...
                return (
                  <div
                    ...
                    className={`p-3.5 rounded-lg border transition-all cursor-pointer relative space-y-2 ${isSelected ? "bg-blue-50/90 border-blue-400 shadow-xs" : notif.isUnread ? "bg-white border-blue-200 shadow-2xs font-medium hover:border-blue-300" : "bg-white border-slate-200/80 opacity-90 hover:opacity-100 hover:border-slate-300"}`}
                  >
                    {/* Unread pulsing indicator */}
                    {notif.isUnread && (
                      <span className="w-2.5 h-2.5 rounded-full bg-blue-600 absolute top-3.5 right-3.5" />
                    )}

                    <div className="flex items-start gap-2.5 pr-4">
                      {/* Priority Icon */}
                      <div
                        className={`w-8 h-8 rounded-md flex items-center justify-center shrink-0 font-bold ${notif.color === "rose" ? "bg-rose-100 text-rose-600" : notif.color === "amber" ? "bg-amber-100 text-amber-700" : notif.color === "emerald" ? "bg-emerald-100 text-emerald-700" : "bg-blue-100 text-blue-700"}`}
                      >
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          <span
                            className={`px-2 py-0.5 rounded-md text-[9px] font-bold ${notif.priority === "Kh\u1EA9n c\u1EA5p" ? "bg-rose-100 text-rose-700" : notif.priority === "Quan tr\u1ECDng" ? "bg-amber-100 text-amber-800" : "bg-slate-100 text-slate-700"}`}
                          >
                            {notif.priority}
                          </span>
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-slate-100/80 text-[10px] text-slate-500">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          title={
                            notif.isUnread
                              ? "\u0110\xE1nh d\u1EA5u \u0111\xE3 \u0111\u1ECDc"
                              : "\u0110\xE1nh d\u1EA5u ch\u01B0a \u0111\u1ECDc"
                          }
                        >
                          {notif.isUnread
                            ? "\u0110\xE3 \u0111\u1ECDc"
            ...
            <div className="bg-white p-5 md:p-6 rounded-lg border border-slate-200/80 shadow-xs space-y-5">
              ...
              <div className="pb-4 border-b border-slate-100 space-y-3">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                    <span
                      className={`px-2.5 py-1 rounded-lg text-xs font-bold ${selectedNotif.priority === "Kh\u1EA9n c\u1EA5p" ? "bg-rose-100 text-rose-800 border border-rose-200" : selectedNotif.priority === "Quan tr\u1ECDng" ? "bg-amber-100 text-amber-800 border border-amber-200" : "bg-blue-100 text-blue-800 border border-blue-200"}`}
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 bg-slate-50 p-3 rounded-md border border-slate-200/80 text-xs font-medium">
                  <div>
              ...
              <div className="space-y-3">
                ...
                <div className="p-4 bg-slate-50/80 rounded-md border border-slate-200/60 text-slate-800 text-xs leading-relaxed whitespace-pre-line font-medium">
                  {selectedNotif.content}
                </div>
              </div>

              {/* ATTACHMENTS */}
              {selectedNotif.attachments &&
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedNotif.attachments.map((file, idx) => (
                        <div
                          ...
                          onClick={() =>
                            showToast(
                              `\u0110ang t\u1EA3i xu\u1ED1ng t\xE0i li\u1EC7u ${file}...`,
                            )
                          }
                        >
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={() =>
                      showToast(
                        "\u0110\xE3 sao ch\xE9p li\xEAn k\u1EBFt th\xF4ng b\xE1o.",
                      )
                    }
      ...
      <div className="bg-white p-5 rounded-lg border border-slate-200/80 shadow-xs space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-bold text-slate-900 text-sm">
                Danh sách Thông báo đã lên lịch gửi
              </h3>
              <p className="text-xs text-slate-500">
                Các thông báo tự động phát theo lịch đặt trước cho sinh viên /
                doanh nghiệp
              </p>
            </div>
          </div>
          <button
            ...
            className="px-3 py-1.5 bg-blue-50 text-blue-700 font-bold text-xs rounded-md hover:bg-blue-100 flex items-center gap-1"
          >
            ...
            <tbody className="divide-y divide-slate-100 font-medium text-slate-800">
              {scheduledList.map((item) => (
                ...
                >
                  ...
                  <td className="p-3">
                    <span
                      className={`px-2 py-0.5 rounded-md text-[10px] font-bold ${item.priority === "Kh\u1EA9n c\u1EA5p" ? "bg-rose-100 text-rose-700" : "bg-amber-100 text-amber-800"}`}
                    >
                      {item.priority}
                    </span>
                  </td>
                  ...
                  <td className="p-3 text-right">
                    <div className="flex items-center justify-end gap-1">
                      <button
                        onClick={() =>
                          showToast(
                            `\u0110ang ch\u1EC9nh s\u1EEDa l\u1ECBch g\u1EEDi "${item.title}"...`,
                          )
                        }
                      ...
                      <button
                        onClick={() => {
                          setScheduledList(
                            scheduledList.filter((s) => s.id !== item.id),
                          );
                          showToast(
                            "\u0110\xE3 h\u1EE7y l\u1ECBch g\u1EEDi th\xF4ng b\xE1o.",
                          );
                        }}
      ...
      {composeOpen && (
        <div className="fixed inset-0 bg-slate-900/50 z-50 flex items-center justify-center p-4">
          <form
            ...
            className="bg-white rounded-lg max-w-xl w-full p-6 shadow-md border border-slate-200 space-y-4 animate-in fade-in zoom-in-95"
          >
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div className="flex items-center gap-2">
                <Mail className="w-5 h-5 text-blue-600" />
                <h3 className="font-bold text-slate-900 text-base">
                  Soạn &amp; Gửi Thông báo Mới
                </h3>
              </div>
              <button
                type="button"
            ...
            <div className="space-y-3.5 text-xs">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  ...
                  >
                    <option value="Toàn bộ sinh viên">
                      Toàn bộ sinh viên HD (28 SV)
                    </option>
                    <option value="Theo lớp">
                      Theo lớp hướng dẫn (Lớp C24A.TH1)
                    </option>
                    <option value="Theo sinh viên">
                      Theo sinh viên cụ thể
                    </option>
                    <option value="Sinh viên chưa nộp báo cáo tuần 5">
                      Sinh viên chưa nộp báo cáo tuần
                    </option>
                  </select>
                </div>
              ...
              <div className="p-2.5 bg-slate-50 border border-slate-200/80 rounded-md text-[11px] text-slate-600 font-medium flex items-center gap-2">
                <Info className="w-4 h-4 text-blue-600 shrink-0" />
                <span>
                  Gửi thông báo trực tiếp tới app của sinh viên thuộc phân bổ.
                  Nhắc: Liên hệ Doanh nghiệp/Mentor qua email hoặc trao đổi trực
                  tiếp.
                </span>
              </div>
            ...
            <div className="flex items-center justify-between pt-2">
              <button
                ...
                onClick={() => {
                  showToast(
                    "\u0110\xE3 l\u01B0u b\u1EA3n nh\xE1p th\xF4ng b\xE1o.",
                  );
                  setComposeOpen(false);
                }}
