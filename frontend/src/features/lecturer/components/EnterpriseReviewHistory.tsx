  ...
  const defaultReviews: EnterpriseReview[] = reviews || [
    {
      ...
      comment:
        "Môi trường làm việc rất chuyên nghiệp, anh Mentor Hải hỗ trợ sát sao các bài toán thực tế. Quy trình CI/CD và Code Review nghiêm ngặt giúp em học hỏi rất nhiều.",
      hiringOffer: true,
    },
    {
      id: "rev-2",
      ...
      comment:
        "Doanh nghiệp cấp máy tính và tài khoản cloud test đầy đủ. Được trực tiếp tham gia dự án Enterprise của khách hàng Nhật Bản.",
      hiringOffer: true,
    },
    {
      id: "rev-3",
      ...
      comment:
        "Văn phòng hiện đại, team làm việc vui vẻ. Đợt thực tập mang lại nhiều kiến thức thực tế.",
      hiringOffer: false,
    },
  ];
    ...
    <div className="bg-white rounded-lg p-5 border border-slate-200/80 shadow-xs space-y-4">
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        <div>
          <h3 className="font-bold text-slate-900 text-sm flex items-center gap-2">
            ...
            Đánh giá môi trường thực tập & Lịch sử hợp tác:{" "}
            <span className="text-blue-600">{enterpriseName}</span>
          </h3>
          <p className="text-[11px] text-slate-500 font-medium">
            Tổng hợp nhận xét thực tế từ Sinh viên các đợt trước
          </p>
        </div>
        <div className="flex items-center gap-1 bg-amber-50 px-3 py-1 rounded-full border border-amber-200 text-xs font-bold text-amber-700">
      ...
      <div className="space-y-3">
        {defaultReviews.map((rev) => (
          <div
            key={rev.id}
            className="p-4 rounded-md border border-slate-200/80 bg-slate-50/50 hover:bg-slate-50 transition-colors space-y-2"
          >
