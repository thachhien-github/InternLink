...
export const EvaluationWorkspace = ({ student, onBack, onSave }) => {
  ...
  const [presentationScore, setPresentationScore] = useState(
    student.presentationScore || 9.5,
  );
  const [commentText, setCommentText] = useState(
    student.lecturerComments ||
      "Sinh vi\xEAn n\u1EAFm v\u1EEFng ki\u1EBFn th\u1EE9c chuy\xEAn m\xF4n, ch\u1EE7 \u0111\u1ED9ng h\u1ECDc h\u1ECFi c\xF4ng ngh\u1EC7 m\u1EDBi t\u1EA1i doanh nghi\u1EC7p. B\xE1o c\xE1o th\u1EF1c t\u1EADp \u0111\u01B0\u1EE3c tr\xECnh b\xE0y m\u1EA1ch l\u1EA1c, k\u1EBFt qu\u1EA3 th\u1EF1c hi\u1EC7n d\u1EF1 \xE1n \u0111\u1EA1t y\xEAu c\u1EA7u cao t\u1EEB Mentor.",
  );
  ...
  const calculateFinalScore = () => {
    if (hasPresentation) {
      ...
      const total =
        processScore * 0.25 + reportScore * 0.35 + enterpriseScore * 0.4;
      return parseFloat(total.toFixed(1));
    }
  };
  ...
  const handleSaveDraft = () => {
    ...
    onSave(updated);
    showToast(
      `\u0110\xE3 l\u01B0u nh\xE1p k\u1EBFt qu\u1EA3 ch\u1EA5m \u0111i\u1EC3m cho ${student.name}`,
    );
  };
  const handleComplete = () => {
    ...
    onSave(updated);
    showToast(
      `\u0110\xE3 ho\xE0n th\xE0nh & ch\xEDnh th\u1EE9c c\xF4ng b\u1ED1 \u0111i\u1EC3m cho ${student.name}`,
    );
  };
  return (
      ...
      <div className="bg-white p-5 rounded-lg border border-slate-200/80 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium mt-0.5">
              Đánh giá chi tiết báo cáo, tổng hợp điểm quá trình và doanh nghiệp
              cho sinh viên.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5 w-full md:w-auto justify-end">
          <button
            ...
            className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs rounded-md transition-colors border border-slate-200 flex items-center gap-1.5"
          >
            ...
            <div className="flex border-b border-slate-200 bg-slate-50/80 p-1 text-xs font-bold">
              {[
                ...
                <button
                  ...
                  className={`flex-1 py-2 text-center rounded-md transition-all ${activeLeftTab === tab.id ? "bg-white text-blue-600 font-bold shadow-xs" : "text-slate-500 hover:text-slate-900"}`}
                >
                  {tab.label}
                </button>
              ))}
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="p-3 bg-slate-50 rounded-md border border-slate-200 flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-slate-400">
                          420 KB • Mentor đã ký tên &amp; đóng dấu
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="p-3 bg-slate-50 rounded-md border border-slate-200 flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <p className="font-bold text-slate-900 text-xs">
                          Slide_Bao_Ve_Thuc_Tap.pptx
                        </p>
                        <p className="text-[10px] text-slate-400">
                          4.2 MB • Nộp ngày 24/10/2026
                        </p>
                      </div>
                    </div>
                ...
                <div className="space-y-2.5">
                  <div className="p-3 bg-blue-50/60 rounded-md border border-blue-200 space-y-1">
                    ...
                    <p className="text-slate-700 italic text-[11px]">
                      "Sinh viên chấp hành tốt kỷ luật lao động, nắm bắt nhanh
                      bài toán nghiệp vụ FPT Software. Đánh giá xuất sắc."
                    </p>
                  </div>
                </div>
              )}
                ...
                <div className="space-y-2">
                  <div className="flex justify-between p-2 bg-slate-50 rounded-lg">
                    ...
                    <strong className="text-blue-700">
                      {student.enterpriseScore || "Ch\u01B0a c\xF3"}
                    </strong>
                  </div>
                  <div className="flex justify-between p-2 bg-slate-50 rounded-lg">
                    <span className="font-medium text-slate-600">
                    ...
                    <strong className="text-blue-700">
                      {student.lecturerScore || "Ch\u01B0a ch\u1EA5m"}
                    </strong>
                  </div>
                  <div className="flex justify-between p-2 bg-slate-50 rounded-lg">
                    <span className="font-medium text-slate-600">
            ...
            <div className="relative pl-6 space-y-4 before:absolute before:left-2.5 before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-200 text-xs">
              ...
              <div className="relative space-y-0.5">
                ...
                <p className="font-bold text-slate-900">
                  Hoàn thành 12/12 Nhật ký thực tập hàng tuần
                </p>
                <p className="text-[10px] text-slate-400">
                  20/10/2026 • Sinh viên đã nộp đầy đủ
                </p>
              </div>
              ...
              <div className="relative space-y-0.5">
                <div className="absolute -left-6 top-0.5 w-3.5 h-3.5 rounded-full bg-emerald-500 border-2 border-white" />
                <p className="font-bold text-slate-900">
                  Nộp Báo cáo thực tập cuối kỳ (File Word)
                </p>
                <p className="text-[10px] text-slate-400">
                  22/10/2026 • Đúng thời hạn qui định
                </p>
              </div>
              ...
              <div className="relative space-y-0.5">
                <div className="absolute -left-6 top-0.5 w-3.5 h-3.5 rounded-full bg-emerald-500 border-2 border-white" />
                <p className="font-bold text-slate-900">
                  Doanh nghiệp tải lên Phiếu đánh giá Mentor
                </p>
                <p className="text-[10px] text-slate-400">
                  23/10/2026 • Đạt 9.2/10 điểm
                </p>
              </div>
              ...
              <div className="relative space-y-0.5">
                ...
                <p className="font-bold text-blue-700">
                  Giảng viên thực hiện chấm điểm cuối kỳ
                </p>
                <p className="text-[10px] text-slate-400">
                  Hôm nay (Đang xử lý)
                </p>
            ...
            <div className="space-y-5 text-xs font-sans">
              ...
              <div className="p-4 bg-slate-50 rounded-lg border border-slate-200/80 space-y-2">
                ...
                <p className="text-[11px] text-slate-500">
                  Dựa trên thái độ, tính kỷ luật và việc nộp báo cáo tuần đúng
                  hạn (12/12 bài).
                </p>
                <input
                  type="range"
              ...
              <div className="p-4 bg-slate-50 rounded-lg border border-slate-200/80 space-y-2">
                <div className="flex items-center justify-between">
                  <label className="font-bold text-slate-900 text-xs">
                    2. Điểm Báo cáo thực tập do Giảng viên chấm (Thang 10 -
                    Trọng số 30%)
                  </label>
                  <span className="font-bold text-blue-700 text-base">
                    {reportScore}
                ...
                <p className="text-[11px] text-slate-500">
                  Đánh giá độ sâu nội dung đề tài, định dạng báo cáo và khối
              ...
              <div className="p-4 bg-slate-50 rounded-lg border border-slate-200/80 space-y-2">
                ...
                <p className="text-[11px] text-slate-500">
                  Lấy trực tiếp từ Phiếu nhận xét chính thức do Mentor{" "}
                  {student.supervisor} ký tên.
                </p>
                <input
                  type="range"
                  min="0"
                  ...
                  onChange={(e) =>
                    setEnterpriseScore(parseFloat(e.target.value))
                  }
                  className="w-full accent-blue-600 cursor-pointer"
                />
              </div>
              ...
              <div className="p-4 bg-slate-50 rounded-lg border border-slate-200/80 space-y-3">
                ...
                {hasPresentation && (
                  <div className="space-y-2 pt-1">
                    <p className="text-[11px] text-slate-500">
                      Điểm thuyết trình và trả lời câu hỏi phản biện của sinh
                      viên trước Hội đồng chấm.
                    </p>
                    <input
                      type="range"
                      min="0"
                      ...
                      onChange={(e) =>
                        setPresentationScore(parseFloat(e.target.value))
                      }
                      className="w-full accent-blue-600 cursor-pointer"
                    />
                  </div>
              ...
              <div className="p-5 bg-slate-50 rounded-lg border border-slate-200 flex items-center justify-between">
                <div>
                ...
                <div className="border border-slate-200 rounded-lg overflow-hidden bg-white focus-within:border-blue-500 transition-colors">
                  <div className="bg-slate-100 p-2 border-b border-slate-200 flex items-center gap-1">
                    ...
                    <button
                      ...
                      onClick={() =>
                        showToast(
                          "Th\xEAm danh s\xE1ch g\u1EA1ch \u0111\u1EA7u d\xF2ng",
                        )
                      }
                      className="p-1.5 hover:bg-slate-200 rounded text-slate-700"
                      title="Danh sách"
