...
export const DocumentDetailWorkspace = ({
  ...
  const handleCopyLink = () => {
    ...
    triggerToast("\u0110\xE3 sao ch\xE9p li\xEAn k\u1EBFt t\xE0i li\u1EC7u v\xE0o b\u1ED9 nh\u1EDB t\u1EA1m!");
  };
  ...
  >
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium mt-0.5">
              Đăng bởi <strong className="text-slate-800">{document.uploader}</strong> ({document.uploaderRole}) • Cập nhật ngày {document.updatedAt}
            </p>
          </div>
        </div>
    ...
    className="px-3 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs rounded-xl transition-colors border border-slate-200 flex items-center gap-1.5"
  >
    ...
    className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-black text-xs rounded-xl shadow-md shadow-blue-500/20 transition-all flex items-center gap-1.5"
  >
    ...
    /* INTERACTIVE DOCUMENT PREVIEWER (8 cols) */
        ...
        <div className="lg:col-span-8 bg-slate-900 rounded-2xl border border-slate-800 shadow-xl overflow-hidden flex flex-col min-h-[600px]">
          {
    /* Toolbar */
  }
  ...
  >
    ...
    className="bg-white text-slate-900 p-10 rounded-xl shadow-2xl max-w-xl w-full min-h-[500px] transition-transform origin-top space-y-6 font-serif border border-slate-200"
  >
              {
              ...
              <div className="space-y-4 text-xs leading-relaxed text-slate-800 font-sans">
                <div className="space-y-1">
                  ...
                  <p className="text-slate-600 text-[11px]">
                    Sinh viên thực hiện quá trình thực tập tại các doanh nghiệp đối tác đã qua thẩm định của Khoa. Thời gian tối thiểu là 12 tuần với tổng số giờ làm việc không dưới 360 giờ.
                  </p>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-slate-600 text-[11px]">
                    - Báo cáo giữa kỳ nộp vào tuần thứ 6 trên hệ thống InternLink.<br />
                    - Báo cáo cuối kỳ có chữ ký xác nhận của Mentor doanh nghiệp và đóng dấu giáp lai.
                  </p>
                </div>
                ...
                <div className="p-3 bg-slate-50 rounded-lg border border-slate-200 text-[11px]">
                  ...
                  <p className="text-slate-600">
                    Sử dụng đúng phông chữ Arial / Times New Roman, cỡ chữ 12pt, giãn dòng 1.3 lines theo quy chuẩn.
                  </p>
                </div>
              </div>
    ...
    /* Document Information Card */
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-4">
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="flex items-center justify-between">
                <span className="text-slate-500 font-medium">Tổng lượt tải xuống:</span>
                <strong className="text-blue-600 font-bold">{document.downloads.toLocaleString()} lượt</strong>
              </div>

              <div className="flex items-center justify-between">
                <span className="text-slate-500 font-medium">Phiên bản hiện tại:</span>
                <strong className="text-emerald-600 font-bold">{document.version} (Latest)</strong>
              </div>
    ...
    /* Version History Log */
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs space-y-3">
            ...
            <div className="space-y-2.5 max-h-60 overflow-y-auto">
              {document.versionHistory?.map((vh, idx) => <div
    key={idx}
    className="p-3 bg-slate-50 rounded-xl border border-slate-100 space-y-1"
  >
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-black text-blue-700">{vh.version}</span>
