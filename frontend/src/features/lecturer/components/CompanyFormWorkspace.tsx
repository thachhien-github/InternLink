...
import { ArrowLeft, Building2, Save, X, Plus, Clock } from "lucide-react";
...
export const CompanyFormWorkspace = ({ initialData, onBack, onSave }) => {
  ...
  const [field, setField] = useState(
    initialData?.field || "C\xF4ng ngh\u1EC7 Th\xF4ng tin / Ph\u1EA7n m\u1EC1m",
  );
  ...
  const validateForm = () => {
    ...
    if (!name.trim())
      errs.name = "Vui l\xF2ng nh\u1EADp t\xEAn doanh nghi\u1EC7p!";
    if (!website.trim()) {
    ...
    if (!location.trim())
      errs.location =
        "Vui l\xF2ng nh\u1EADp \u0111\u1ECBa ch\u1EC9 tr\u1EE5 s\u1EDF!";
    if (!contactPerson.trim())
      errs.contactPerson =
        "Vui l\xF2ng nh\u1EADp t\xEAn ng\u01B0\u1EDDi li\xEAn h\u1EC7!";
    ...
    if (!contactPhone.trim())
      errs.contactPhone =
        "Vui l\xF2ng nh\u1EADp s\u1ED1 \u0111i\u1EC7n tho\u1EA1i li\xEAn h\u1EC7!";
    setErrors(errs);
  ...
  const handleAddPosition = () => {
    if (
      ...
      !positions.includes(newPositionInput.trim())
    ) {
  ...
  const handleSubmit = (isDraft = false) => {
    if (!isDraft && !validateForm()) {
      triggerToast(
        "Vui l\xF2ng ki\u1EC3m tra l\u1EA1i c\xE1c th\xF4ng tin c\xF2n thi\u1EBFu!",
      );
      return;
    }
    const payload = {
      ...
      status: isDraft
        ? "Ch\u1EDD duy\u1EC7t"
        : isEditing
          ? initialData?.status || "\u0110ang h\u1EE3p t\xE1c"
          : "\u0110ang h\u1EE3p t\xE1c",
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-slate-900 tracking-tight">
                {isEditing
                  ? `Ch\u1EC9nh s\u1EEDa th\xF4ng tin: ${initialData.name}`
                  : "Th\xEAm doanh nghi\u1EC7p m\u1EDBi"}
              </h1>
            </div>
            <p className="text-xs text-slate-500 font-medium mt-0.5">
              Nhập đầy đủ hồ sơ đối tác doanh nghiệp để quản lý và phân công
              sinh viên thực tập.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                className={`w-full p-2.5 bg-slate-50 border rounded-md outline-none font-semibold text-slate-900 transition-colors ${errors.name ? "border-rose-500 bg-rose-50/50" : "border-slate-200 focus:border-blue-500 focus:bg-white"}`}
              />
              {errors.name && (
            ...
            <div>
              ...
              <select
                ...
                className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-md outline-none font-semibold text-slate-900 focus:border-blue-500 focus:bg-white"
              >
                <option value="Công nghệ Thông tin / Phần mềm">
                  Công nghệ Thông tin / Phần mềm
                </option>
                <option value="Viễn thông & Giải pháp Số">
                  Viễn thông &amp; Giải pháp Số
                </option>
                <option value="Ngân hàng / Fintech">Ngân hàng / Fintech</option>
                <option value="Internet / Trò chơi / Cloud">
                  Internet / Trò chơi / Cloud
                </option>
                <option value="Công nghệ Ô tô / AI Mobility">
                  Công nghệ Ô tô / AI Mobility
                </option>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-2.5 bg-slate-50 border rounded-md outline-none font-semibold text-slate-900 transition-colors ${errors.website ? "border-rose-500 bg-rose-50/50" : "border-slate-200 focus:border-blue-500 focus:bg-white"}`}
              />
              {errors.website && (
                <p className="text-[11px] text-rose-500 font-bold mt-1">
                  {errors.website}
            ...
            <div>
              <label className="block font-bold text-slate-800 mb-1">
                Địa chỉ trụ sở / Chi nhánh thực tập{" "}
              ...
              <input
                ...
                className={`w-full p-2.5 bg-slate-50 border rounded-md outline-none font-semibold text-slate-900 transition-colors ${errors.location ? "border-rose-500 bg-rose-50/50" : "border-slate-200 focus:border-blue-500 focus:bg-white"}`}
              />
              {errors.location && (
                <p className="text-[11px] text-rose-500 font-bold mt-1">
                  {errors.location}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-2.5 bg-slate-50 border rounded-md outline-none font-semibold text-slate-900 transition-colors ${errors.contactPerson ? "border-rose-500 bg-rose-50/50" : "border-slate-200 focus:border-blue-500 focus:bg-white"}`}
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-2.5 bg-slate-50 border rounded-md outline-none font-semibold text-slate-900 transition-colors ${errors.contactEmail ? "border-rose-500 bg-rose-50/50" : "border-slate-200 focus:border-blue-500 focus:bg-white"}`}
              />
              {errors.contactEmail && (
                <p className="text-[11px] text-rose-500 font-bold mt-1">
                  {errors.contactEmail}
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-2.5 bg-slate-50 border rounded-md outline-none font-semibold text-slate-900 transition-colors ${errors.contactPhone ? "border-rose-500 bg-rose-50/50" : "border-slate-200 focus:border-blue-500 focus:bg-white"}`}
              />
              {errors.contactPhone && (
                <p className="text-[11px] text-rose-500 font-bold mt-1">
                  {errors.contactPhone}
        ...
        <div className="bg-white p-6 rounded-lg border border-slate-200/80 shadow-xs space-y-4">
          ...
          <div className="space-y-4 text-xs">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mb-2">
                <input
                  ...
                  className="flex-1 p-2 bg-slate-50 border border-slate-200 rounded-md outline-none text-xs font-medium"
                />
                <button
                  type="button"
                  onClick={handleAddPosition}
                  className="px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-md text-xs flex items-center gap-1"
                >
              ...
              <div className="flex flex-wrap gap-2">
                {positions.map((pos, pIdx) => (
                  <span
                    key={pIdx}
                    className="px-3 py-1 bg-blue-50 text-blue-800 font-bold rounded-md border border-blue-200 flex items-center gap-1.5"
                  >
                    <span>{pos}</span>
                    <button
                      type="button"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block font-bold text-slate-800 mb-1">
                  Chỉ tiêu tiếp nhận tối đa (Sinh viên)
                </label>
                <input
                  type="number"
                  min="1"
        ...
        <div className="bg-white p-6 rounded-lg border border-slate-200/80 shadow-xs space-y-4">
          ...
          <div className="space-y-2 text-xs">
            <p className="text-slate-500 italic">
              * Ghi chú này chỉ hiển thị cho Giảng viên hướng dẫn &amp; Ban quản
              lý thực tập Khoa, sinh viên không xem được.
            </p>
            <textarea
              rows={3}
              value={internalNotes}
