  ...
  const positionsList = [
    {
      ...
      status: "\u0110ang tuy\u1EC3n",
      description:
        "Tham gia x\xE2y d\u1EF1ng h\u1EC7 th\u1ED1ng Enterprise Web Apps cho kh\xE1ch h\xE0ng Nh\u1EADt B\u1EA3n & Ch\xE2u \xC2u.",
    },
    {
      ...
      status: "\u0110ang tuy\u1EC3n",
      description:
        "Nghi\xEAn c\u1EE9u \xE1p d\u1EE5ng Generative AI & RAG cho quy tr\xECnh t\u1EF1 \u0111\u1ED9ng h\xF3a t\xE0i li\u1EC7u.",
    },
    {
      ...
      status: "\u0110ang tuy\u1EC3n",
      description:
        "H\u1ED7 tr\u1EE3 thi\u1EBFt l\u1EADp CI/CD pipelines & qu\u1EA3n tr\u1ECB c\u1EE5m Kubernetes Staging.",
    },
    {
      ...
      description:
        "Ph\xE1t tri\u1EC3n ph\u1EA7n m\u1EC1m nh\xFAng cho c\xE1c d\xF2ng \xF4 t\xF4 \u0111i\u1EC7n th\xF4ng minh th\u1EBF h\u1EC7 m\u1EDBi.",
    },
  ];
  ...
  const reviewsList = [
    {
      id: 1,
      author:
        "TS. Ph\u1EA1m Minh Anh (Gi\u1EA3ng vi\xEAn h\u01B0\u1EDBng d\u1EABn)",
      role: "Gi\u1EA3ng vi\xEAn",
      time: "15/10/2026",
      rating: 5,
      comment:
        "Doanh nghi\u1EC7p c\xF3 quy tr\xECnh \u0111\xE0o t\u1EA1o b\xE0i b\u1EA3n, ph\xE2n c\xF4ng Mentor 1-on-1 s\xE1t sao. M\xF4i tr\u01B0\u1EDDng th\u1EF1c t\u1EBF gi\xFAp sinh vi\xEAn n\xE2ng cao k\u1EF9 n\u0103ng m\u1EC1m v\xE0 l\xE0m vi\u1EC7c nh\xF3m c\u1EF1c k\u1EF3 nhanh ch\xF3ng.",
    },
    {
      id: 2,
      author:
        "Nguy\u1EC5n V\u0103n A (Sinh vi\xEAn th\u1EF1c t\u1EADp kh\xF3a 2021)",
      role: "Sinh vi\xEAn",
      time: "02/10/2026",
      rating: 5,
      comment:
        "Tr\u1EE3 c\u1EA5p h\xE0ng th\xE1ng \u0111\xFAng h\u1EA1n, \u0111\u01B0\u1EE3c tr\u1EF1c ti\u1EBFp vi\u1EBFt code cho d\u1EF1 \xE1n l\u1EDBn c\u1EE7a kh\xE1ch h\xE0ng Nh\u1EADt B\u1EA3n. C\u0103ng tin c\xF3 \u0111\u1EA7y \u0111\u1EE7 \u0111\u1ED3 \u0103n th\u1EE9c u\u1ED1ng mi\u1EC5n ph\xED, xe bus \u0111\u01B0a \u0111\xF3n t\u1EADn n\u01A1i.",
    },
    {
      id: 3,
      ...
      rating: 4.8,
      comment:
        "Kh\u1ED1i l\u01B0\u1EE3ng c\xF4ng vi\u1EC7c kh\xE1 nhi\u1EC1u nh\u01B0ng h\u1ECDc h\u1ECFi \u0111\u01B0\u1EE3c r\u1EA5t nhi\u1EC1u c\xF4ng ngh\u1EC7 m\u1EDBi nh\u01B0 Docker, K8s v\xE0 Microservices.",
    },
  ];
  return (
    <div className="space-y-6 animate-in fade-in duration-200 pb-12 font-sans">
      ...
      <div className="bg-white rounded-lg border border-slate-200/80 shadow-xs p-6 space-y-6 relative overflow-hidden">
        <div className="flex flex-col lg:flex-row items-start justify-between gap-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="px-2.5 py-0.5 bg-amber-100 text-amber-900 border border-amber-300 font-bold text-[10px] rounded-full flex items-center gap-1">
              ...
              <p className="text-xs font-semibold text-slate-600 flex items-center gap-1">
                ...
                {company.field ||
                  "C\xF4ng ngh\u1EC7 Th\xF4ng tin / Ph\u1EA7n m\u1EC1m"}
              </p>
          ...
          <div className="flex items-center gap-2.5 w-full lg:w-auto shrink-0 justify-end flex-wrap">
            <button
              onClick={() => {
                triggerToast(
                  `\u0110\xE3 g\u1EEDi email \u0111\u1EC1 xu\u1EA5t h\u1EE3p t\xE1c \u0111\u1EBFn ${company.contactEmail}`,
                );
              }}
              className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs rounded-md border border-slate-200 transition-colors flex items-center gap-1.5"
            >
            ...
            <button
              onClick={() =>
                triggerToast(
                  `\u0110\xE3 xu\u1EA5t h\u1ED3 s\u01A1 h\u1EE3p t\xE1c & ch\u1EC9 ti\xEAu th\u1EF1c t\u1EADp c\u1EE7a ${company.shortCode}`,
                )
              }
              className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs rounded-md border border-slate-200 transition-colors flex items-center gap-1.5"
            >
            ...
            <button
              onClick={() => {
                ...
                triggerToast(
                  `M\u1EDF giao di\u1EC7n ph\xE2n c\xF4ng sinh vi\xEAn th\u1EF1c t\u1EADp cho ${company.shortCode}`,
                );
              }}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-4 border-t border-slate-100 text-xs">
          ...
          <div className="p-3 bg-slate-50 rounded-md space-y-0.5">
            <span className="text-[10px] font-bold text-slate-400 uppercase">
              Số lượng tiếp nhận đợt này
            </span>
            <p className="font-bold text-blue-600 text-sm">
              {company.studentCount} / {company.capacity || 50}{" "}
        ...
        <div className="flex items-center gap-1 border-b border-slate-200 pt-2 overflow-x-auto no-scrollbar">
          {[
            ...
            {
              id: "positions",
              label: "V\u1ECB tr\xED tuy\u1EC3n (4)",
              icon: Briefcase,
            },
            {
              id: "interns",
              label: "Sinh vi\xEAn \u0111\xE3 th\u1EF1c t\u1EADp (38)",
              icon: Users,
            },
            {
              id: "evaluations",
              label: "\u0110\xE1nh gi\xE1 & Ph\u1EA3n h\u1ED3i",
              icon: Star,
            },
            {
              id: "history",
              label: "L\u1ECBch s\u1EED h\u1EE3p t\xE1c",
              icon: Calendar,
            },
          ].map((tab) => {
            const Icon = tab.icon;
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-5 rounded-lg border border-slate-200/80 shadow-xs space-y-3">
              ...
              <p className="text-xs text-slate-700 leading-relaxed text-justify">
                FPT Software là công ty con thuộc Tập đoàn FPT, hiện là doanh
                nghiệp xuất khẩu phần mềm và cung cấp dịch vụ công nghệ thông
                tin lớn nhất Việt Nam với hơn 30.000 nhân sự toàn cầu. Với vai
                trò đối tác chiến lược hàng đầu của trường, FPT Software tiếp
                nhận sinh viên thực tập liên tục trong cả 3 học kỳ hàng năm cho
                các mảng Web, Mobile, AI, Cloud và Automotive.
              </p>
            </div>
              ...
              <div className="bg-white p-5 rounded-lg border border-slate-200/80 shadow-xs space-y-3">
                ...
                <ul className="text-xs text-slate-700 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Sinh viên năm 3 hoặc năm 4 các ngành CNTT, KhMT, HTTT.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" />
                    <span>
                      Đã hoàn thành các môn học cơ sở ngành (DSA, OOP, CSDL).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" />
                    <span>
                      Có khả năng cam kết thực tập tối thiểu 3 - 4 tháng
                      (40h/tuần).
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white p-5 rounded-lg border border-slate-200/80 shadow-xs space-y-3">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {[
                    ...
                    <span
                      key={idx}
                      className="px-2.5 py-1 bg-slate-100 text-slate-800 font-bold text-[11px] rounded-md border border-slate-200"
                    >
                      {skill}
                    </span>
                  ))}
            ...
            <div className="bg-white p-5 rounded-lg border border-slate-200/80 shadow-xs space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-slate-700">
                <div className="space-y-1.5">
                  ...
                  <p>
                    • Được hướng dẫn trực tiếp 1-on-1 bởi Mentor có kinh nghiệm
                    chuyên môn sâu.
                  </p>
                  <p>
                    • Cơ hội chuyển chính thức ngay sau đợt thực tập đạt kết quả
                    Tốt.
                  </p>
                  <p>
                    • Xe bus đưa đón nhân viên tại các điểm trung tâm Hà Nội
                    &amp; TP.HCM.
                  </p>
                </div>
                <div className="space-y-1.5">
                  ...
                  <p>
                    • Thứ Hai - Thứ Sáu: 08:30 - 17:30 (Nghỉ trưa 12:00 -
                    13:00).
                  </p>
                  <p>
                    • Hình thức: Onsite tại Campus FPT Hòa Lạc hoặc F-Town 3.
                  </p>
                </div>
              </div>
            </div>
              ...
              {positionsList.map((pos, idx) => (
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <span
                      className={`px-2.5 py-1 text-[10px] font-bold rounded-full shrink-0 ${pos.status === "\u0110ang tuy\u1EC3n" ? "bg-emerald-100 text-emerald-800 border border-emerald-300" : "bg-slate-100 text-slate-600 border border-slate-300"}`}
                    >
                      {pos.status}
                    </span>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-slate-100 text-xs">
                    <div className="flex items-center gap-1.5 flex-wrap">
                      ...
                      {pos.tech.map((t, tIdx) => (
                        <span
                          key={tIdx}
                          className="px-2 py-0.5 bg-blue-50 text-blue-700 font-bold text-[10px] rounded-md border border-blue-100"
                        >
                          {t}
                        </span>
                      ))}
            ...
            <div className="bg-white p-5 rounded-lg border border-slate-200/80 shadow-xs space-y-3">
              ...
              <div className="space-y-3">
                {reviewsList.map((rev) => (
                  <div
                    key={rev.id}
                    className="p-4 bg-slate-50 rounded-md border border-slate-200 space-y-2"
                  >
                    <div className="flex items-center justify-between">
            ...
            <div className="space-y-3 text-xs border-l-2 border-blue-600 pl-4">
              <div className="space-y-1">
                <span className="font-bold text-slate-900">
                  01/01/2026 - Ký kết thỏa thuận hợp tác đào tạo (MOU 2026-2028)
                </span>
                <p className="text-slate-600">
                  Tăng chỉ tiêu tiếp nhận từ 30 SV lên 50 SV/học kỳ và tài trợ
                  học bổng thực tập sinh tài năng.
                </p>
              </div>
              <div className="space-y-1 pt-2">
                <span className="font-bold text-slate-900">
                  15/08/2025 - Tổ chức Ngày hội tuyển dụng InternDay 2025 tại
                  Trường
                </span>
                <p className="text-slate-600">
                  Tuyển trực tiếp 42 sinh viên thực tập các ngành Kỹ thuật Phần
                  mềm và Khoa học Dữ liệu.
                </p>
              </div>
            </div>
          </div>
