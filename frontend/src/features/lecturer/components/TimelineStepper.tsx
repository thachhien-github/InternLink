...
export const TimelineStepper = ({
    ...
    <div className="il-panel p-5 md:p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2.5">
          <div className="p-2 bg-blue-50 text-blue-600 rounded-md border border-blue-100/80">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-500 font-medium">
              Theo dõi các mốc thời gian quy định
            </p>
          </div>
        </div>
        <span className="text-xs font-bold text-blue-700 bg-blue-50 border border-blue-200/80 px-3 py-1 rounded-full font-display">
          {currentTerm}
        </span>
      </div>
      ...
      <div className="relative px-3 pt-1 pb-2">
        ...
        <div className="absolute top-5 left-8 right-8 h-1 bg-slate-100 rounded-full -z-0">
          <div className="h-full bg-[#1d4ed8] w-[55%] rounded-full shadow-xs" />
        </div>
 ...
 : isCurrent
 ? "bg-[#1d4ed8] text-white ring-4 ring-blue-100 scale-110 shadow-sm "
 : "bg-slate-50 text-slate-400 border border-slate-200"
                ...
                >
                  {isCompleted ? (
                    ...
                    <span className="il-kpi-val">{step.number}</span>
                  )}
                </div>
