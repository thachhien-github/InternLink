...
import { MOCK_NOTIFICATION_ACTIVITY_LOGS } from "../../../lib/mockNotificationActivityLogs";
...
export const NotificationsView = ({ onShowToast, onNavigateTab }) => {
  const { stats: navStats } = useAdminNavStats(!USE_MOCK);
  const [notifications, setNotifications] = useState(USE_MOCK ? [
    {
      id: "TB-2026-089",
      title:
        "Kh\u1EA9n: Y\xEAu c\u1EA7u c\u1EADp nh\u1EADt B\xE1o c\xE1o Th\u1EF1c t\u1EADp Tu\u1EA7n 8 tr\u01B0\u1EDBc 17:00",
      content:
        "T\u1EA5t c\u1EA3 sinh vi\xEAn K20 \u0111ang tham gia th\u1EF1c t\u1EADp t\u1EA1i doanh nghi\u1EC7p b\u1EAFt bu\u1ED9c ho\xE0n t\u1EA5t vi\u1EC7c n\u1ED9p b\xE1o c\xE1o ti\u1EBFn \u0111\u1ED9 tu\u1EA7n 8 l\xEAn h\u1EC7 th\u1ED1ng InternLink \u0111\u1EC3 Gi\u1EA3ng vi\xEAn h\u01B0\u1EDBng d\u1EABn ch\u1EA5m \u0111i\u1EC3m \u0111\xFAng h\u1EA1n.",
      type: "Kh\u1EA9n c\u1EA5p",
      priority: "urgent",
    ...
    },
    {
      id: "TB-2026-088",
      title:
        "Th\xF4ng b\xE1o L\u1ECBch h\u1ECDp H\u1ED9i \u0111\u1ED3ng \u0110\xE1nh gi\xE1 Th\u1EF1c t\u1EADp HK2 (2025-2026)",
      content:
        "K\xEDnh g\u1EEDi Qu\xFD Th\u1EA7y/C\xF4 Gi\u1EA3ng vi\xEAn h\u01B0\u1EDBng d\u1EABn, Ban Khoa CNTT tr\xE2n tr\u1ECDng k\xEDnh m\u1EDDi Th\u1EA7y/C\xF4 tham d\u1EF1 bu\u1ED5i h\u1ECDp r\xE0 so\xE1t k\u1EBFt qu\u1EA3 \u0111\xE1nh gi\xE1 th\u1EF1c t\u1EADp h\u1ECDc k\u1EF3 2.",
      type: "L\u1ECBch tr\xECnh",
      priority: "high",
    ...
    },
    {
      id: "TB-2026-087",
      title:
        "Nh\u1EAFc nh\u1EDF \u0110\u0103ng k\xFD Nguy\u1EC7n v\u1ECDng Doanh nghi\u1EC7p Th\u1EF1c t\u1EADp \u0110\u1EE3t 2",
      content:
        "H\u1EC7 th\u1ED1ng \u0111\xE3 m\u1EDF c\u1ED5ng ti\u1EBFp nh\u1EADn \u0111\u0103ng k\xFD b\u1ED5 sung nguy\u1EC7n v\u1ECDng th\u1EF1c t\u1EADp t\u1EA1i c\xE1c doanh nghi\u1EC7p \u0111\u1ED1i t\xE1c \u0111\u1EE3t 2. H\u1EA1n ch\xF3t \u0111\u0103ng k\xFD l\xE0 23:59 ng\xE0y 05/08/2026.",
      type: "H\u1ECDc t\u1EADp",
      priority: "medium",
    ...
    },
    {
      id: "TB-2026-086",
      title:
        "C\u1EADp nh\u1EADt Quy ch\u1EBF \u0110\xE1nh gi\xE1 \u0110i\u1EC3m Th\u1EF1c t\u1EADp T\u1ED1t nghi\u1EC7p n\u0103m 2026",
      content:
        "Tr\u01B0\u1EDDng \u0110\u1EA1i h\u1ECDc S\u01B0 ph\u1EA1m K\u1EF9 thu\u1EADt TP.HCM ban h\xE0nh quy ch\u1EBF m\u1EDBi v\u1EC1 c\u01A1 c\u1EA5u \u0111i\u1EC3m th\u1EF1c t\u1EADp: 40% Doanh nghi\u1EC7p, 30% GVHD, 30% H\u1ED9i \u0111\u1ED3ng ph\u1EA3n bi\u1EC7n.",
      type: "Quy ch\u1EBF",
      priority: "high",
      audienceType: "all",
      audienceLabel:
        "To\xE0n b\u1ED9 H\u1EC7 th\u1ED1ng (1,322 ng\u01B0\u1EDDi)",
      recipientCount: 1322,
    ...
    },
    {
      id: "TB-2026-085",
      title:
        "B\u1EA3o tr\xEC H\u1EC7 th\u1ED1ng C\u1ED5ng th\xF4ng tin InternLink ng\xE0y 08/08",
      content:
        "H\u1EC7 th\u1ED1ng InternLink s\u1EBD t\u1EA1m ng\u1EEBng ho\u1EA1t \u0111\u1ED9ng t\u1EEB 00:00 \u0111\u1EBFn 04:00 ng\xE0y 08/08/2026 \u0111\u1EC3 n\xE2ng c\u1EA5p h\u1EA1 t\u1EA7ng m\xE1y ch\u1EE7 m\xE1y h\u1ECDc v\xE0 b\u1EA3o m\u1EADt.",
      type: "H\u1EC7 th\u1ED1ng",
      priority: "medium",
      audienceType: "all",
      audienceLabel:
    ...
    },
    {
      id: "TB-2026-084",
      title:
        "H\u01B0\u1EDBng d\u1EABn Sinh vi\xEAn L\u1EDBp 20CNTT1 n\u1ED9p S\u1ED5 nh\u1EADt k\xFD th\u1EF1c t\u1EADp \u0111\u1EE3t 1",
      content:
        "Nh\u1EAFc nh\u1EDF ri\xEAng l\u1EDBp 20CNTT1 chu\u1EA9n b\u1ECB file scan s\u1ED5 nh\u1EADt k\xFD c\xF3 ch\u1EEF k\xFD x\xE1c nh\u1EADn c\u1EE7a c\xE1n b\u1ED9 h\u01B0\u1EDBng d\u1EABn t\u1EA1i doanh nghi\u1EC7p.",
      type: "\u0110\xE1nh gi\xE1",
      priority: "low",
      audienceType: "class",
    ...
    },
    {
      id: "TB-2026-083",
      title:
        "Th\xF4ng b\xE1o ph\xE2n c\xF4ng Gi\u1EA3ng vi\xEAn H\u01B0\u1EDBng d\u1EABn \u0110\u1EE3t b\u1ED5 sung th\xE1ng 8",
      content:
        "\u0110\xE3 ho\xE0n t\u1EA5t ph\xE2n c\xF4ng 12 sinh vi\xEAn n\u1ED9p tr\u1EC5 v\xE0o c\xE1c nh\xF3m gi\u1EA3ng vi\xEAn b\u1ED9 m\xF4n C\xF4ng ngh\u1EC7 ph\u1EA7n m\u1EC1m.",
      type: "H\u1ECDc t\u1EADp",
      priority: "medium",
  ...
  const [composeCustomAudienceDetail, setComposeCustomAudienceDetail] =
    useState("all_system");
  ...
  const calculatedRecipientCount = useMemo(() => {
    if (!USE_MOCK && navStats) {
      switch (composeAudience) {
        case "all":
          return navStats.studentCount + navStats.lecturerCount;
        case "lecturer":
          return navStats.lecturerCount;
        case "student":
          return navStats.studentCount;
        default:
          return navStats.studentCount + navStats.lecturerCount;
      }
    }
  ...
  }, [composeAudience, composeCustomAudienceDetail, navStats]);
  const calculatedAudienceLabel = useMemo(() => {
    switch (composeAudience) {
      ...
      case "semester":
        return composeCustomAudienceDetail === "hk1_2026"
          ? "K\u1EF3 HK1 (2026-2027) - 850 SV"
          : "K\u1EF3 HK2 (2025-2026) - 430 SV";
      case "class":
        return composeCustomAudienceDetail === "20cntt1"
          ? "L\u1EDBp 20CNTT1 (45 SV)"
          : "L\u1EDBp 20KTPM1 (42 SV)";
      case "faculty":
  ...
  const sentNotifs = notifications.filter(
    (n) => n.status === "sent" && n.totalRecipients > 0,
  );
  const avgReadRate =
    sentNotifs.length > 0
      ? Math.round(
          sentNotifs.reduce(
            (acc, curr) => acc + (curr.readCount / curr.totalRecipients) * 100,
            0,
          ) / sentNotifs.length,
        )
      : 92;
  ...
  const handleFileAttachmentSim = () => {
    ...
    onShowToast(
      "\u0110\xE3 \u0111\xEDnh k\xE8m t\u1EC7p Thong_Bao_Moi_2026_InternLink.pdf th\xE0nh c\xF4ng!",
    );
  };
  const handleSaveDraft = () => {
    if (!composeTitle.trim()) {
      onShowToast(
        "Vui l\xF2ng nh\u1EADp ti\xEAu \u0111\u1EC1 th\xF4ng b\xE1o tr\u01B0\u1EDBc khi l\u01B0u nh\xE1p.",
      );
      return;
    }
    const newNotif = {
      ...
      title: composeTitle,
      content:
        composeContent || "N\u1ED9i dung ch\u01B0a c\u1EADp nh\u1EADt...",
      type: composeType,
    ...
    onShowToast(
      `\u0110\xE3 l\u01B0u b\u1EA3n nh\xE1p "${composeTitle}" th\xE0nh c\xF4ng!`,
    );
    resetComposeForm();
  };
  const handleSendNow = async () => {
    ...
    const apiAudience =
      composeAudience === "student" || composeAudience === "lecturer"
        ? composeAudience
        : composeAudience === "all"
          ? "all"
          : null;

    if (!USE_MOCK && !apiAudience) {
      onShowToast(
        "API hiện hỗ trợ gửi tới: Toàn hệ thống, Sinh viên, hoặc Giảng viên.",
      );
      return;
    }
    ...
    try {
      if (!USE_MOCK && apiAudience) {
        const result = await adminNotificationsService.broadcast({
        ...
        await loadCampaigns();
        onShowToast(
          `Đã gửi thông báo tới ${result.recipientCount} người nhận`,
        );
        resetComposeForm();
        return;
      }
      ...
      setNotifications([newNotif, ...notifications]);
      onShowToast(
        `Đã gửi thông báo đến ${calculatedRecipientCount} người nhận (mock)`,
      );
      resetComposeForm();
    } catch (err) {
      onShowToast(getApiErrorMessage(err));
  ...
  const handleScheduleSend = () => {
    if (!composeTitle.trim() || !composeContent.trim()) {
      onShowToast(
        "Vui l\xF2ng nh\u1EADp \u0111\u1EA7y \u0111\u1EE7 Ti\xEAu \u0111\u1EC1 v\xE0 N\u1ED9i dung th\xF4ng b\xE1o.",
      );
      return;
    }
    setIsLoading(true);
    setTimeout(() => {
      ...
      setNotifications([newNotif, ...notifications]);
      onShowToast(
        `\u0110\xE3 l\xEAn l\u1ECBch g\u1EEDi v\xE0o l\xFAc ${scheduledDateTime} th\xE0nh c\xF4ng!`,
      );
  ...
  const handleQuickUrgentBroadcast = () => {
    setComposeTitle(
      "KH\u1EA8N: C\u1EA3nh b\xE1o th\u1EDDi h\u1EA1n n\u1ED9p b\xE1o c\xE1o v\xE0 ch\u1EA5m \u0111i\u1EC3m h\u1EC7 th\u1ED1ng InternLink",
    );
    setComposeContent(
      "K\xEDnh g\u1EEDi Qu\xFD Th\u1EA7y/C\xF4 v\xE0 c\xE1c b\u1EA1n Sinh vi\xEAn, h\u1EC7 th\u1ED1ng ghi nh\u1EADn c\xF2n m\u1ED9t s\u1ED1 h\u1ED3 s\u01A1 ch\u01B0a ho\xE0n t\u1EA5t. Vui l\xF2ng ki\u1EC3m tra v\xE0 x\u1EED l\xFD g\u1EA5p tr\u01B0\u1EDBc 17:00 h\xF4m nay.",
    );
    ...
    onShowToast(
      '\u0110\xE3 t\u1EA3i m\u1EABu Th\xF4ng b\xE1o Kh\u1EA9n c\u1EA5p. H\xE3y ki\u1EC3m tra l\u1EA1i v\xE0 b\u1EA5m "G\u1EEDi ngay".',
    );
  };
  const handleCancelSchedule = (id) => {
    ...
    onShowToast(
      `\u0110\xE3 h\u1EE7y l\u1ECBch g\u1EEDi th\xF4ng b\xE1o ${id} v\xE0 chuy\u1EC3n th\xE0nh b\u1EA3n nh\xE1p.`,
    );
  };
  ...
  const handleDeleteNotification = (notif) => {
    if (USE_MOCK || !notif.campaignSentAt) {
      setNotifications((prev) => prev.filter((n) => n.id !== notif.id));
      onShowToast(`Đã xóa thông báo.`);
      return;
    }
    setDeleteTarget({
      id: notif.id,
      ...
      campaignSentAt: notif.campaignSentAt,
    });
  };
  ...
  const confirmDeleteNotification = async () => {
    ...
    setIsDeleting(true);
    try {
      await adminNotificationsService.deleteCampaign({
        title: deleteTarget.title,
        content: deleteTarget.content,
        sentAt: deleteTarget.campaignSentAt,
      });
      setNotifications((prev) => prev.filter((n) => n.id !== deleteTarget.id));
      onShowToast("Đã xóa thông báo khỏi hệ thống");
  ...
  const handleExportHistory = () => {
    if (notifications.length === 0) {
      onShowToast("Không có thông báo để xuất.");
      return;
    }
    exportNotificationsHistoryCsv(
      notifications.map((n) => ({
        ...
        recipientCount: n.recipientCount ?? n.totalRecipients ?? 0,
        readCount: n.readCount ?? 0,
        sentAt: n.sentAt ?? n.createdAt ?? "—",
        status: n.status === "sent" ? "Đã gửi" : n.status,
      })),
    );
    onShowToast(
      `Đã xuất ${notifications.length} thông báo ra file CSV.`,
    );
  };
  return (
    <div className="space-y-5 max-w-[1500px] mx-auto min-w-0 max-w-full overflow-hidden">
      <PageHeader
        icon={Bell}
        title="Thông báo (Notification Center)"
        actions={[
          {
            label: "Xuất lịch sử",
            icon: Download,
          ...
          },
          {
            ...
            onClick: () => {
              setComposeAudience("all");
              onShowToast("Đã chọn nhóm đối tượng Toàn hệ thống.");
            },
            variant: "primary",
          },
        ]}
      >
        <button
          ...
          className="il-btn-press px-3.5 py-2 bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs rounded-md shadow-xs transition-all flex items-center gap-1.5"
        >
      ...
      <KpiGrid>
        ...
        <KpiCard
          ...
          unit="thông báo"
          icon={CheckCircle2}
          footer="Đã phát hành thành công"
        />
        <KpiCard
          tone="rose"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start min-w-0 max-w-full">
        ...
        <div className="lg:col-span-8 space-y-6 min-w-0 max-w-full">
          ...
          <Panel className="space-y-5 relative overflow-hidden">
            {isUrgentFastSend && (
              <div className="bg-rose-50 border border-rose-200 text-rose-800 p-3 rounded-md text-xs font-bold flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <ShieldAlert className="w-4 h-4 text-rose-600 shrink-0" />
                  <span>
                    Đang ở chế độ <strong>Phát hành Thông báo Khẩn cấp</strong>!
                    Vui lòng rà soát cẩn thận trước khi gửi.
                  </span>
                </div>
                <button
                  onClick={() => setIsUrgentFastSend(false)}
            ...
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h2 className="text-base font-bold text-slate-900 tracking-tight">
                    Soạn thông báo mới (Compose Center)
                  </h2>
                  <p className="text-xs text-slate-500 font-medium">
                    Tạo thông báo, chọn nhóm người nhận mục tiêu và phát hành
              ...
              <div className="px-3 py-1.5 bg-blue-50 text-blue-900 rounded-md border border-blue-200 text-xs font-bold flex items-center gap-2 shadow-2xs">
                <Users className="w-4 h-4 text-blue-600" />
                <span>
                  Dự kiến gửi tới:{" "}
                  <strong className="text-blue-700 font-bold">
                    {calculatedRecipientCount.toLocaleString("vi-VN")}
                  </strong>{" "}
                  người nhận
                </span>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-md font-bold text-slate-900 text-xs outline-none focus:bg-white focus:border-blue-500 transition-colors"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-md font-bold text-slate-800 text-xs outline-none focus:bg-white focus:border-blue-500 cursor-pointer"
                  >
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="lecturer">Toàn bộ Giảng viên</option>
                    <option value="student">Toàn bộ Sinh viên</option>
                    {USE_MOCK && (
                      <>
              ...
              {(USE_MOCK && (composeAudience === "semester" ||
                composeAudience === "class")) && (
                <div className="p-3 bg-blue-50/50 rounded-md border border-blue-200/60 text-xs flex items-center justify-between gap-3">
                  <span className="font-bold text-blue-900 shrink-0">
                    Chi tiết nhóm chọn:
                  </span>
                  {composeAudience === "semester" ? (
                    <select
                      value={composeCustomAudienceDetail}
                      onChange={(e) =>
                        setComposeCustomAudienceDetail(e.target.value)
                      }
                      className="px-3 py-1.5 bg-white border border-blue-200 rounded-lg font-bold text-slate-800 outline-none"
                    >
                      <option value="hk1_2026">
                        Kỳ HK1 (2026-2027) - 850 sinh viên
                      </option>
                      <option value="hk2_2025">
                        Kỳ HK2 (2025-2026) - 430 sinh viên
                      </option>
                    </select>
                  ) : (
                    <select
                      ...
                      className="px-3 py-1.5 bg-white border border-blue-200 rounded-lg font-bold text-slate-800 outline-none"
                    >
                      <option value="20cntt1">
                        Lớp 20CNTT1 (45 sinh viên)
                      </option>
                      <option value="20ktpm1">
                        Lớp 20KTPM1 (42 sinh viên)
                      </option>
                    </select>
                  )}
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3.5 bg-slate-50 border border-slate-200 rounded-md font-medium text-slate-900 text-xs outline-none focus:bg-white focus:border-blue-500 transition-colors resize-y"
                />
              </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-1">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs rounded-md transition-colors border border-slate-200 flex items-center gap-1.5"
                  >
                  ...
                  {composeAttachment && (
                    <div className="px-2.5 py-1 bg-emerald-50 text-emerald-800 border border-emerald-200 rounded-lg text-xs font-bold flex items-center gap-1.5">
                ...
                <button
                  ...
                  className={`px-3 py-1.5 font-bold text-xs rounded-md border transition-colors flex items-center gap-1.5 ${showSchedulePicker ? "bg-blue-50 text-blue-700 border-blue-300" : "bg-slate-100 text-slate-700 border-slate-200 hover:bg-slate-200"}`}
                >
                  <CalendarClock className="w-3.5 h-3.5" />
                  <span>
                    {showSchedulePicker
                      ? "\u1EA8n c\xE0i \u0111\u1EB7t l\xEAn l\u1ECBch"
                      : "T\xF9y ch\u1ECDn L\xEAn l\u1ECBch g\u1EEDi"}
                  </span>
                </button>
                )}
              </div>
              ...
              {USE_MOCK && showSchedulePicker && (
                <div className="p-4 bg-blue-50/60 rounded-md border border-blue-200 space-y-3 animate-in fade-in duration-200">
                  ...
                  <p className="text-[10px] text-blue-700 font-medium italic">
                    * Hệ thống Server InternLink sẽ tự động phát hành thông báo
                    đúng thời gian này đến tất cả thiết bị của người nhận.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="flex flex-wrap items-center justify-end gap-2.5 pt-3 border-t border-slate-100">
              ...
              <button
                ...
                className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold text-xs rounded-md transition-colors border border-slate-200"
              >
                Lưu nháp
              </button>
              )}
              ...
              {USE_MOCK && showSchedulePicker ? (
                <button
                  ...
                  disabled={isLoading}
                  className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-md shadow-xs transition-all flex items-center gap-1.5 disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={isLoading}
                  className={`px-5 py-2 text-white font-bold text-xs rounded-md shadow-xs transition-all flex items-center gap-1.5 disabled:opacity-50 ${composePriority === "urgent" ? "bg-rose-600 hover:bg-rose-700" : "bg-emerald-600 hover:bg-emerald-700"}`}
                >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-3">
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium mt-0.5">
                  Quản lý và tra cứu trạng thái toàn bộ thông báo đã phát hành
                  hoặc đang lên lịch.
                </p>
              </div>

              {/* Tab Selector */}
              <div className="flex items-center gap-1 p-1 bg-slate-100 rounded-md text-xs font-bold">
                <button
                      ...
                      return (
                        ...
                        >
                            ...
                            <div className="space-y-0.5">
                              <div className="flex items-center gap-1.5">
                                ...
                                {notif.attachmentName && (
                                  <span title={notif.attachmentName}>
                          ...
                          <td className="py-3 px-3 text-center">
                            <span
                              className={`px-2 py-0.5 rounded-md text-[10px] font-bold border ${getTypeBadge(notif.type)}`}
                            >
                              {notif.type}
                            </span>
                          </td>
          ...
          <Panel className="space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium mt-0.5">
                  Danh sách các thông báo đã được cấu hình gửi tự động theo thời
                  gian chỉ định.
                </p>
              </div>
            </div>
            ...
            {scheduledNotifications.length === 0 ? (
              <div className="p-8 text-center text-slate-400 font-medium bg-slate-50 rounded-md border border-dashed border-slate-200">
                Hiện tại không có thông báo nào đang trong hàng đợi lên lịch.
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                {scheduledNotifications.map((sItem) => (
                  <div
                    key={sItem.id}
                    className="p-4 bg-slate-50/80 rounded-md border border-slate-200/80 space-y-3 relative hover:border-blue-300 transition-colors"
                  >
                    <div className="flex items-start justify-between gap-2">
                      <span className="px-2 py-0.5 bg-blue-100 text-blue-800 rounded-md text-[10px] font-bold border border-blue-200 inline-flex items-center gap-1">
                    ...
                    <div className="flex items-center justify-between text-[11px] pt-2 border-t border-slate-200/60 text-slate-600">
                      <span>
                        Người nhận: <strong>{sItem.audienceLabel}</strong>
                      </span>
                      <span className="font-bold text-blue-700">
                        {sItem.recipientCount} người
                      </span>
                    </div>
                    ...
                    <div className="flex items-center justify-end gap-2 pt-1">
                      <button
                        onClick={() => {
                          ...
                          onShowToast(
                            "\u0110\xE3 t\u1EA3i th\xF4ng b\xE1o l\xEAn l\u1ECBch v\xE0o khung ch\u1EC9nh s\u1EEDa.",
                          );
                        }}
          ...
          <Panel className="space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium mt-0.5">
                  Thống kê phản hồi đọc thông báo theo phân nhóm đối tượng và
                  mốc thời gian.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-slate-50/70 rounded-md border border-slate-200/80 space-y-3">
              ...
              <div className="p-4 bg-slate-50/70 rounded-md border border-slate-200/80 space-y-3">
                ...
                <div className="space-y-2 text-xs">
                  <div className="flex items-center justify-between p-2 bg-white rounded-lg border border-slate-200">
                    <span className="font-bold text-slate-700">
                      Mở đọc trong 1 giờ đầu:
                    </span>
                    <span className="font-bold text-emerald-600">68.5%</span>
                  </div>
                  <div className="flex items-center justify-between p-2 bg-white rounded-lg border border-slate-200">
                    <span className="font-bold text-slate-700">
                      Mở đọc trong 24 giờ:
                ...
                <p className="text-[10px] text-slate-500 font-medium italic text-center">
                  * Tự động gửi tin nhắn SMS / Zalo nhắc nhở đối với các trường
                  hợp chưa đọc sau 24h đối với thông báo Khẩn.
                </p>
              </div>
            </div>
          </Panel>
          ...
          <Panel className="space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium mt-0.5">
                  Theo dõi tiến trình: Đã gửi thông báo ↓ Sinh viên đã đọc ↓
            ...
            <div className="space-y-3 relative before:absolute before:inset-0 before:left-3.5 before:w-0.5 before:bg-slate-100">
              {MOCK_NOTIFICATION_ACTIVITY_LOGS.map((log) => (
                <div
                  key={log.id}
                  className="flex items-start gap-3 relative z-10 pl-1"
                >
                  <div
                    className={`w-6 h-6 rounded-full flex items-center justify-center shrink-0 border text-xs font-bold shadow-2xs ${log.type === "sent" ? "bg-blue-50 text-blue-700 border-blue-200" : log.type === "read" ? "bg-emerald-50 text-emerald-700 border-emerald-200" : log.type === "confirmed" ? "bg-slate-100 text-slate-700 border-slate-200" : "bg-amber-50 text-amber-700 border-amber-200"}`}
                  >
                    {log.type === "sent" ? (
        ...
        <div className="lg:col-span-4 space-y-6 min-w-0 max-w-full">
          ...
          <Panel className="space-y-3.5">
            ...
            {scheduledNotifications.length === 0 ? (
              <p className="text-xs text-slate-400 font-medium text-center py-2">
                Không có lịch gửi thông báo hôm nay.
              </p>
            ) : (
              <div className="space-y-2.5">
                {scheduledNotifications.map((sn) => (
                  <div
                    key={sn.id}
                    className="p-3 bg-blue-50/40 rounded-md border border-blue-100 space-y-1.5"
                  >
          ...
          <Panel className="space-y-3.5">
            ...
            <div className="space-y-2.5 text-xs">
              <div className="p-3 bg-slate-50 rounded-md border border-slate-200 space-y-1">
                <div className="flex justify-between font-bold">
                  <span className="text-slate-800">
                    Lớp 20KTPM2 (Khoa CNTT)
                  </span>
                  <span className="text-rose-600 font-bold">24% chưa đọc</span>
                </div>
                <div className="w-full bg-slate-200 rounded-full h-1.5 overflow-hidden">
                  <div
                ...
                <p className="text-[10px] text-slate-400 font-medium">
                  11/45 sinh viên chưa mở thông báo Tuần 8
                </p>
              </div>
              ...
              <div className="p-3 bg-slate-50 rounded-md border border-slate-200 space-y-1">
                <div className="flex justify-between font-bold">
                  <span className="text-slate-800">
                    Lớp 20HTTT1 (Khoa CNTT)
                  </span>
                  <span className="text-amber-600 font-bold">18% chưa đọc</span>
                </div>
                <div className="w-full bg-slate-200 rounded-full h-1.5 overflow-hidden">
                  <div
                    className="bg-amber-500 h-full rounded-full"
                ...
                <p className="text-[10px] text-slate-400 font-medium">
                  8/44 sinh viên chưa mở thông báo Tuần 8
                </p>
              </div>
            </div>
          </Panel>
          ...
          <Panel className="space-y-3.5">
            ...
            <div className="p-3 bg-rose-50/70 border border-rose-200 rounded-md space-y-1.5">
          ...
          <Panel className="space-y-3">
            ...
            <div className="space-y-2 text-xs font-medium">
              ...
              <div className="flex justify-between">
                <span className="text-slate-500">
                  Cổng Push Notification Mobile App:
                </span>
                <span className="font-bold text-emerald-600">
                  Sẵn sàng (FCM API)
                </span>
      ...
      {isDetailOpen && selectedNotif && (
        <div className="fixed inset-0 z-50 bg-slate-900/40 flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-lg max-w-2xl w-full border border-slate-200 shadow-md overflow-hidden space-y-4 p-6 animate-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                <span className="px-2.5 py-1 bg-blue-50 text-blue-800 rounded-lg text-xs font-mono font-bold border border-blue-200">
                  {selectedNotif.id}
                </span>
                <span
                  className={`px-2 py-0.5 rounded-md text-[10px] font-bold border ${getTypeBadge(selectedNotif.type)}`}
                >
                  {selectedNotif.type}
                </span>
              </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 bg-slate-50 p-3 rounded-md text-xs">
                <div>
                ...
                <div>
                  ...
                  <span className="font-bold text-emerald-600">
                    {selectedNotif.readCount} / {selectedNotif.totalRecipients}{" "}
                    (
                    {selectedNotif.totalRecipients > 0
                      ? Math.round(
                          (selectedNotif.readCount /
                            selectedNotif.totalRecipients) *
                            100,
                        )
                      : 0}
                    %)
              ...
              <div className="p-4 bg-slate-50/80 rounded-md border border-slate-200 text-xs text-slate-800 leading-relaxed font-medium space-y-2">
              ...
              {selectedNotif.attachmentName && (
                <div className="p-3 bg-emerald-50/80 border border-emerald-200 rounded-md text-xs flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] text-emerald-700 font-medium">
                        Kích thước: {selectedNotif.attachmentSize}
                      </span>
                    </div>
                  </div>
                  <button
                    onClick={() =>
                      onShowToast(
                        `\u0110ang t\u1EA3i t\u1EC7p \u0111\xEDnh k\xE8m ${selectedNotif.attachmentName}...`,
                      )
                    }
            ...
            <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-100">
              <button
                onClick={() => setIsDetailOpen(false)}
                className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold text-xs rounded-md"
              >
                Đóng
              </button>
            </div>
      ...
      <ConfirmDialog
        ...
        description={
          deleteTarget ? (
            <>
              Xóa thông báo{" "}
              <strong className="text-slate-900">{deleteTarget.title}</strong> khỏi
              toàn bộ người nhận? Không thể hoàn tác.
            </>
          ) : null
        }
