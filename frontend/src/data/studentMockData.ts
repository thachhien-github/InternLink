...
export const STUDENT_PROFILE: StudentProfile = {
  ...
  currentPhase: "Đang thực tập (Tuần 6 / 8)"
};
...
export const INITIAL_STUDENT_TASKS: StudentTask[] = [
  ...
  {
    id: "st-4",
    title: "Xác nhận tiếp nhận và quy chế thực tập từ Doanh nghiệp FPT Software",
    deadline: "12/09/2026",
...
export const STUDENT_FEEDBACKS: StudentFeedback[] = [
  {
    ...
    preview: "Báo cáo tuần 5 trình bày rất chi tiết. Cần bổ sung sơ đồ ERD cho module Payment trong tuần 6 tới.",
    detail: "Thầy đã nhận xét báo cáo tuần 5 của em. Phần tổng quan công việc và thời gian làm việc tại doanh nghiệp rất đầy đủ. Tuy nhiên để đạt điểm tối đa ở phần kiến trúc hệ thống, em cần vẽ sơ đồ quan hệ cơ sở dữ liệu (ERD) cho module Payment mà em phụ trách. Tiếp tục phát huy nhé!",
    status: "Đã phản hồi",
  ...
  },
  {
    ...
    timeAgo: "2 giờ trước",
    preview: "Xác nhận em A làm việc chủ động, hoàn thành đúng tiến độ task React UI và phối hợp tốt với team Backend.",
    detail: "Nguyễn Văn A có tinh thần học hỏi rất cao. Trong 2 tuần vừa qua, em đã tự chủ động học Tailwind và Zustand để hoàn thành 4 trang UI quan trọng cho dự án. Mức độ tuân thủ giờ giấc làm việc tại FPT Software đạt 100%. Đánh giá xuất sắc.",
    status: "Đánh giá tốt",
...
export const STUDENT_NOTIFICATIONS: StudentNotification[] = [
  {
    id: "sn-1",
    title: "Biểu mẫu mới: Mẫu phiếu đánh giá doanh nghiệp đợt I 2026 đã sẵn sàng tải về.",
  ...
  {
    id: "sn-3",
    title: "Cảnh báo hạn nộp: Báo cáo tuần 6 còn 3 ngày nữa là hết hạn (23:59 - 22/09).",
    timeAgo: "3 giờ trước",
    unread: true,
    type: "deadline"
  },
  {
    id: "sn-4",
    title: "Doanh nghiệp FPT Software đã xác nhận tiếp nhận hồ sơ thực tập sinh.",
